...
out_marg$error_dist <- 
  factor(mapvalues(out_marg$error_dist, from = c("heavy-tailed", "homoscedastic", "heteroscedastic", "skewed"), 
...
##### Visualize type I and II coverage rates
...
##### Visualize interval width ratios
...
##### Visualize Type III and IV coverage rates
...
out_cond_cov$error_dist <- 
  factor(mapvalues(out_cond_cov$error_dist, from = c("heavy-tailed", "homoscedastic", "heteroscedastic"), 
